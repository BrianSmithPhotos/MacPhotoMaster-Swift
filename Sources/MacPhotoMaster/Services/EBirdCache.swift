...
actor EBirdCache {
    ...
    func taxonomyFetchedAt() throws -> Date? {
    ...
    func replaceTaxonomy(_ entries: [EBirdTaxonEntry]) throws {
    ...
    func taxonomyEntries(forSpeciesCodes speciesCodes: [String]) throws -> [EBirdTaxonEntry] {
    ...
    func cachedSpeciesCodes(regionCode: String) throws -> (codes: [String], fetchedAt: Date)? {
        try dbQueue.read { db in
            guard
    ...
    func storeSpeciesCodes(_ codes: [String], regionCode: String) throws {
