...
enum ElevationLookupError: Error {
...
struct ElevationLookupService {
    ...
    func lookupElevation(latitude: Double, longitude: Double) async throws -> Double {
    ...
    static func extractValue(from payload: [String: Any]) -> Double? {
