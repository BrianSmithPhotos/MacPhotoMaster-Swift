...
enum NativeMetadataWriteError: Error {
...
struct NativeMetadataWriter: MetadataWriter {
    func write(title: String?, description: String, keywords: [String], gps: GPSCoordinate?, to url: URL)
        async throws
    {
