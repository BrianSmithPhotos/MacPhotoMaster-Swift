...
actor ProcessedStateStore {
    ...
    func markProcessed(assetPaths: [String], inFolder folderPath: String) throws {
    ...
    func processedAssetPaths(inFolder folderPath: String) throws -> Set<String> {
