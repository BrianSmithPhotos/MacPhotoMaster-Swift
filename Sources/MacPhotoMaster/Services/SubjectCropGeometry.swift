...
enum SubjectCropGeometry {
    ...
    static func fitRect(imageSize: CGSize, containerSize: CGSize) -> CGRect {
    ...
    static func imageRect(forViewRect viewRect: CGRect, imageSize: CGSize, containerSize: CGSize)
        -> CGRect
    {
    ...
    static func viewRect(forImageRect imageRect: CGRect, imageSize: CGSize, containerSize: CGSize)
        -> CGRect
    {
