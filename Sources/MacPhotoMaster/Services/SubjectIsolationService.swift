...
enum SubjectIsolationService {
    ...
    static func isolateSubject(in image: CGImage) -> CGImage? {
    ...
    static func boundingBox(ofNonZeroPixelsIn pixelBuffer: CVPixelBuffer) -> CGRect? {
    ...
    static func pad(_ rect: CGRect, by fraction: CGFloat, clampingTo image: CGImage) -> CGRect {
