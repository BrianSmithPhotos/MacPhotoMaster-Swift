...
enum TimelineDriveSync {
    ...
    static func resolveDriveSourcePath(
        cloudStorageDirectory: URL = FileManager.default.homeDirectoryForCurrentUser
    ...
    static func resolveLocalCopyPath(
        environment: [String: String] = ProcessInfo.processInfo.environment
    ) throws -> URL {
    ...
    @discardableResult
    static func syncIfNewer(driveSource: URL, localCopy: URL) throws -> Bool {
