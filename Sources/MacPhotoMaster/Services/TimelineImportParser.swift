...
enum TimelineImportError: Error {
    case unreadableFile
    case invalidJSON
...
struct TimelineImportParser {
    func parseSamples(fromFileAt url: URL) throws -> [TimelineSample] {
    ...
    func parseSamples(from data: Data) throws -> [TimelineSample] {
